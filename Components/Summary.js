...
export default function Summary() {
  const [bgColorUnpaid, setBgColorUnpaid] = useState("violet.900");
    ...
    return (
      <Button
        ...
        onPress={() => {
          if (renderPaid === true) {
            setRenderPaid(false);
            setBgColorUnpaid("violet.900");
            setBgColorPaid("grey");
          } else {
            setRenderPaid(true);
            setBgColorUnpaid("grey");
            setBgColorPaid("violet.900");
          }
        }}
      >
        Paid
                  ...
                  <HStack alignItems="center" mb="3" mr="3">
                    <Button
                      ...
                      onPress={() => {
                        ...
                        newFavorites[newFavorites.indexOf(favorite)].selected =
                          !newFavorites[newFavorites.indexOf(favorite)]
                            .selected;
                    ...
                    <Spacer />
                    {renderPaid ? null : (
                      <Text>${Number.parseFloat(totalBalance).toFixed(2)}</Text>
                    )}
                  </HStack>
                  <HStack>
                    <Text pl="12">Qty</Text>
                      ...
                      <HStack alignItems="center" mb="3" mr="3">
                        <Button
                          ...
                          onPress={() => {
                            ...
                            newFriends[newFriends.indexOf(friend)].selected =
                              !newFriends[newFriends.indexOf(friend)].selected;
