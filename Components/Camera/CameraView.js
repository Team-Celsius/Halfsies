    ...
    <ZStack>
      ...
      <VStack w="100%" h="100%">
        ...
        <HStack alignSelf="center" mb="10">
          <Spacer />
          <IconButton onPress={retake} icon={<FontAwesome5 name="redo" size={50} color="red" />} />
          <Spacer />
          {/* when we build the next step of the user flow, this will go there */}
          <IconButton onPress={confirmPhoto} icon={<FontAwesome5 name="check" size={50} color="green" />} />
          <Spacer />
        </HStack>
      </VStack>
    </ZStack>
